<div align="center">
    ...
    <!-- Banner placeholder: insert image link if needed -->
</div>


<div align="center">
    <h2>🚀 About</h2>
    <p><strong>I’m a System Architect and Engineer who turns complexity into intelligent, reliable systems.</strong></p>
    <p>I design and build end-to-end solutions where hardware, data, and software operate as one — from edge devices and real-time data pipelines to resilient backends and autonomous control logic.</p>
    <p>I thrive at the intersection of the physical and digital. My focus is Edge-AI and Industrial IoT, with a deep specialization in predictive maintenance and autonomous systems — solutions that sense, learn, and act with purpose.</p>
    <p>I combine architectural vision with hands-on execution: clarity in design, discipline in implementation, and measurable impact in operation.<br>(Yes, I sometimes build robots for fun — it keeps my systems thinking grounded in reality.)</p>

   <h3>⚙️ Core Strengths</h3>
    <ul align="left">
        <li><strong>Edge-to-Cloud Architecture</strong> — robust, observable, and scalable by design</li>
        <li><strong>Predictive Systems</strong> — transforming sensor data into early warnings and intelligent decisions</li>
        <li><strong>Automation & Reliability</strong> — fail-safe workflows, tight feedback loops, and measurable SLIs/SLOs</li>
        <li><strong>Data Pipelines</strong> — real-time acquisition, time-series analytics, and anomaly detection</li>
        <li><strong>Builder’s Mindset</strong> — from wiring and firmware to APIs, dashboards, and operations</li>
    </ul>

   <h3>🎯 What Drives Me</h3>
   <p><em>Precision. Integrity. And the quiet satisfaction of systems that keep working — and keep getting smarter with every iteration.</em></p>
</div>
